function [out1,out2,DC,D,AT,tissue1,tissue2] = experiment4(I1, I2, I1clutter,I2clutter)
...
% average teh atoms in the tissue dictionary
...
D = LearnDictionaryRegistered(I1, I2, params);
% Clean the clutter part from D2 (TA-MCA)
...
[out1,out2,tissue1,tissue2] = FusionTARegisteredSingleDict(D1C, D2C, D, AT, I1, I2, params, startFrame, stopFrame, Mask);
