function [first_exper, last_exper, ...
    ...
    ] = figureNoiseBatch(IQdata, artIQ, first_exper, last_exper, SNRs, Mvalue, Nvalue, taus, OMP_ERROR, ATOM_THRs) 

% max_exper = last_exper-first_exper+1; % total  of experiments in this job
max_exper = last_exper; % total  of experiments in this job
...
% Results tables
CNR_KSVDC  = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));
CNR2_KSVDC = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));
PSNR_KSVDC = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));
MSE_KSVDC  = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));
PSNR2_KSVDC = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));
MSE2_KSVDC  = zeros(max_exper,numel(SNRs),numel(ATOM_THRs));

CNR_SVF  = zeros(max_exper,numel(SNRs),numel(taus));
CNR2_SVF = zeros(max_exper,numel(SNRs),numel(taus));
PSNR_SVF = zeros(max_exper,numel(SNRs),numel(taus));
MSE_SVF  = zeros(max_exper,numel(SNRs),numel(taus));
PSNR2_SVF = zeros(max_exper,numel(SNRs),numel(taus));
MSE2_SVF  = zeros(max_exper,numel(SNRs),numel(taus));

CNR_FIR  = zeros(max_exper,numel(SNRs));
CNR2_FIR = zeros(max_exper,numel(SNRs));
PSNR_FIR = zeros(max_exper,numel(SNRs));
MSE_FIR  = zeros(max_exper,numel(SNRs));
PSNR2_FIR = zeros(max_exper,numel(SNRs));
MSE2_FIR  = zeros(max_exper,numel(SNRs));

CNR_BMODE  = zeros(max_exper,numel(SNRs));
CNR2_BMODE = zeros(max_exper,numel(SNRs));
PSNR_BMODE = zeros(max_exper,numel(SNRs));
MSE_BMODE  = zeros(max_exper,numel(SNRs));
PSNR2_BMODE = zeros(max_exper,numel(SNRs));
MSE2_BMODE  = zeros(max_exper,numel(SNRs));

CNR_PF  = zeros(max_exper,numel(SNRs));
CNR2_PF = zeros(max_exper,numel(SNRs));
PSNR_PF = zeros(max_exper,numel(SNRs));
MSE_PF  = zeros(max_exper,numel(SNRs));
