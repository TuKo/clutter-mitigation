function [first_exper, last_exper, ...
    ...
    ] = figureFramesBatch(IQdata, artIQ, first_exper, last_exper, Mvalue, Nvalues, taus, OMP_ERROR, ATOM_THRs)
...
% Results tables
CNR_KSVDC  = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));
CNR2_KSVDC = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));
PSNR_KSVDC = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));
MSE_KSVDC  = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));
PSNR2_KSVDC = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));
MSE2_KSVDC  = zeros(max_exper,numel(Nvalues),numel(ATOM_THRs));

CNR_SVF  = zeros(max_exper,numel(Nvalues),numel(taus));
CNR2_SVF = zeros(max_exper,numel(Nvalues),numel(taus));
PSNR_SVF = zeros(max_exper,numel(Nvalues),numel(taus));
MSE_SVF  = zeros(max_exper,numel(Nvalues),numel(taus));
PSNR2_SVF = zeros(max_exper,numel(Nvalues),numel(taus));
MSE2_SVF  = zeros(max_exper,numel(Nvalues),numel(taus));
