function [first_exper, last_exper, ...
    ...
    ] = figureMotionBatch(IQdata, artIQ, first_exper, last_exper, shifts, Mvalue, Nvalue, taus, OMP_ERROR, ATOM_THRs) 
...
% Results tables
CNR_KSVDC  = zeros(max_exper,numel(shifts),numel(ATOM_THRs));
CNR2_KSVDC = zeros(max_exper,numel(shifts),numel(ATOM_THRs));
PSNR_KSVDC = zeros(max_exper,numel(shifts),numel(ATOM_THRs));
MSE_KSVDC  = zeros(max_exper,numel(shifts),numel(ATOM_THRs));
PSNR2_KSVDC = zeros(max_exper,numel(shifts),numel(ATOM_THRs));
MSE2_KSVDC  = zeros(max_exper,numel(shifts),numel(ATOM_THRs));

CNR_SVF  = zeros(max_exper,numel(shifts),numel(taus));
CNR2_SVF = zeros(max_exper,numel(shifts),numel(taus));
PSNR_SVF = zeros(max_exper,numel(shifts),numel(taus));
MSE_SVF  = zeros(max_exper,numel(shifts),numel(taus));
PSNR2_SVF = zeros(max_exper,numel(shifts),numel(taus));
MSE2_SVF  = zeros(max_exper,numel(shifts),numel(taus));

CNR_FIR  = zeros(max_exper,numel(shifts));
CNR2_FIR = zeros(max_exper,numel(shifts));
PSNR_FIR = zeros(max_exper,numel(shifts));
MSE_FIR  = zeros(max_exper,numel(shifts));
PSNR2_FIR = zeros(max_exper,numel(shifts));
MSE2_FIR  = zeros(max_exper,numel(shifts));

CNR_BMODE  = zeros(max_exper,numel(shifts));
CNR2_BMODE = zeros(max_exper,numel(shifts));
PSNR_BMODE = zeros(max_exper,numel(shifts));
MSE_BMODE  = zeros(max_exper,numel(shifts));
PSNR2_BMODE = zeros(max_exper,numel(shifts));
MSE2_BMODE  = zeros(max_exper,numel(shifts));

CNR_PF  = zeros(max_exper,numel(shifts));
CNR2_PF = zeros(max_exper,numel(shifts));
PSNR_PF = zeros(max_exper,numel(shifts));
MSE_PF  = zeros(max_exper,numel(shifts));
